                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <select id="seatclass" name="seatclass" class="seatclass" onChange={(e) => {setHangGhe(e.target.value)}}>
                                    <option value="Phổ thông" onSelect={(e) => setHangGhe("Phổ thông")}>Phổ thông</option>
                                    <option value="Phổ thông đặc biệt" onSelect={(e) => setHangGhe("Phổ thông đặc biệt")}>Phổ thông đặc biệt</option>
                                    <option value="Thương gia" onSelect={(e) => setHangGhe("Thương gia")}>Thương gia</option>
                                    <option value="Hạng nhất" onSelect={(e) => setHangGhe("Hạng nhất")}>Hạng nhất</option>
                                </select>
                            </td>
                        </tr>
                    </table>
