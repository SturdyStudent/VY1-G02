      ...
      <div>
        ...
        <div class="middle" >
            ...
            <form>
                <table id='table'>
                    <tr id='tr'>
                        <th class="titlelong">Thông tin liên hệ (nhận vé/phiếu thanh toán)</th>
                        <th class="fixbttn"><button id='button'>Lưu</button></th>
                    </tr>
                    <tr id='tr'>
                        <td>
        ...
        <br/><br/>
        <a href="XemThongTinDatCho.html">Tiếp tục</a>
        </div>  
    </div>
  )
}
